...
fn test_scheduler_creation_size64(#[case] builder: I2o2Builder) {
...
fn test_scheduler_creation_size128(#[case] builder: I2o2Builder) {
    let (_scheduler, _handle) = builder
        .try_create_size128::<()>()
        .expect("builder should be produce valid scheduler");
}
...
fn failpoint_test_scheduler_creation_size64(#[case] builder: I2o2Builder) {
...
#[case::failpoint_kernel_v6_0_registered_buffers(crate::builder().with_num_registered_buffers(8))]
#[case::failpoint_kernel_v6_1_registered_buffers(crate::builder().with_num_registered_buffers(8))]
fn failpoint_test_scheduler_creation_size128(#[case] builder: I2o2Builder) {
    let scenario = FailScenario::setup();
    let (_scheduler, _handle) = builder
        .try_create_size128::<()>()
        .expect("builder should be produce valid scheduler");
